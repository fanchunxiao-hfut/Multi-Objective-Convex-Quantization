...
# utils 
#--------------
from dataloader import custom_datasets
#--------------
# torchvision
#--------------
...
def dataloader(args):
    if args.data_type == 'mnist':
        ...
        valid_loader = torch.utils.data.DataLoader( 
            datasets.MNIST(args.data_path, train=False, download=True,
                       transform=transforms.Compose([
                            # transforms.RandomHorizontalFlip(),
                            # transforms.Resize((32,32)),
                            transforms.ToTensor(),
        ...
        train_loader = torch.utils.data.DataLoader(trainset, pin_memory=False,
                                                   batch_size=args.batch_size,
                                                   sampler=train_sampler,
                                                   shuffle=(train_sampler is None),
                                                   num_workers=args.workers)
        
        valid_loader = torch.utils.data.DataLoader(validset, pin_memory=False,
                                                   batch_size=args.batch_size,
                                                   sampler=None,
                                                   shuffle=True,
                                                   num_workers=args.workers)
