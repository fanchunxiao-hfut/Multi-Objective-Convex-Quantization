...
class ResNet_Cifar100(nn.Module):
    def __init__(self, block, num_blocks, inflation=1, num_classes=100):
...
def resnet20():
    return ResNet_Cifar100(BasicBlock, [3, 3, 3])

def resnet32():
    return ResNet_Cifar100(BasicBlock, [5, 5, 5], inflation=1)

def resnet44():
    return ResNet_Cifar100(BasicBlock, [7, 7, 7])

def resnet56():
    return ResNet_Cifar100(BasicBlock, [9, 9, 9])

def resnet110():
    return ResNet_Cifar100(BasicBlock, [18, 18, 18])
